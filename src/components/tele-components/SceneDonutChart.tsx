                        ...
                        <>
                            {centerValue && (
                                <text x={cx} y={centerLabel ? cy - 4 : cy} textAnchor="middle" dominantBaseline="central"
                                    className="font-hero text-body" fill={`${getColor(90)}`} fontWeight="bold">
                                    {centerValue}
                                </text>
                            )}
                            {centerLabel && (
                    ...
                    {segments.map((seg, i) => {
                        ...
                        return (
                            <div key={i} className="flex items-center gap-1.5">
                                ...
                                <span className="font-data text-body uppercase tracking-wider font-medium whitespace-nowrap" style={{ color: `${getColor(88)}` }}>
