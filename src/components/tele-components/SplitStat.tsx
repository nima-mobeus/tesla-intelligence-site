        ...
        <div className="flex flex-col h-full justify-center gap-1.5">
            <div className="flex items-stretch gap-3">
                <div className="flex-1 text-center">
                    <div className="font-data text-body uppercase tracking-wider" style={{ color: `${getColor(70)}` }}>{leftLabel}</div>
                    <div className="font-hero text-title leading-none mt-1" style={{ color: `${getColor(90)}` }}>{leftValue}</div>
                </div>
                <div className="w-px self-stretch" style={{ backgroundColor: `${getColor(13)}` }} />
                <div className="flex-1 text-center">
                    <div className="font-data text-body uppercase tracking-wider" style={{ color: `${getColor(70)}` }}>{rightLabel}</div>
                    <div className="font-hero text-title leading-none mt-1" style={{ color: `${getColor(90)}` }}>{rightValue}</div>
                </div>
            </div>
            {comparison && (
                <div className="text-center font-data text-body font-bold" style={{ color: trend ? TREND_CLR[trend] : `${getColor(70)}` }}>
