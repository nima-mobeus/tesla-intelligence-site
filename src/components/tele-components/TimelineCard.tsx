          ...
          return (
            <div key={i} className="flex items-start gap-2">
              ...
              <div className="min-w-0 pb-1">
                ...
                <div className="font-data text-body font-bold leading-tight" style={{ color: getColor(90) }}>{e.title}</div>
                {e.impact && (
                  <div className="font-voice text-body leading-tight" style={{ color: getColor(70) }}>{e.impact}</div>
                )}
              </div>
            </div>
          );
