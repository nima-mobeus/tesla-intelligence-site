                ...
                <table className="w-full border-collapse">
                    <thead>
                        <tr>
                            <th />
                            {cols.map((c, i) => (
                                <th key={i} className="font-data text-body uppercase tracking-wider px-1 py-1 text-center text-card-primary">
                                    {c}
                                </th>
                            ))}
                        </tr>
                    ...
                    <tbody>
                        {rows.map((row, ri) => (
                            <tr key={ri}>
                                <td className="font-data text-body uppercase tracking-wider pr-2 py-1 text-left whitespace-nowrap font-bold text-card-primary">
                                    {row}
                                </td>
