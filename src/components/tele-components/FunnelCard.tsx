        ...
        {stages.map((s, i) => {
          ...
          return (
            <div key={i} className="w-full flex flex-col items-center">
              {convRate && (
                <span className="font-data text-body mb-0.5" style={{ color: getColor(70) }}>↓ {convRate}%</span>
              )}
              <div
              ...
              >
                <span className="font-data text-body text-white font-bold truncate">{s.label}</span>
                <span className="font-data text-body text-white font-bold">
